...
# Sertifika dosyalarının yolları ve alan adının ortam değişkenleri olarak ayarlandığından emin olun
...
# Sertifika dosyası mevcut değilse, yeni bir SSL sertifikası oluştur
